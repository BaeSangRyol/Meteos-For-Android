...
public class Game implements ApplicationListener {
      ...
      public void render() {
            ...
            for ( int row = 0; row < NUMBER_OF_ROWS; row++ ) {
                  for ( int col = 0; col < NUMBER_OF_COLUMNS; col++ ) {
                        ...
                        spriteBatch.draw(texture, convertNormalXToGLX(currentBrick.getMf_x()), convertNormalYToGLY(currentBrick.getMf_y()), mBlockWidth, mBlockHeight, 0, 0, texture.getWidth(), texture.getHeight(), false,false);
      ...
      private void processInput() {       
            if ( Gdx.input.justTouched() ) {
                  ...
                  int r = (int) (x / mBlockWidth);
                  mi_CurrentBlockCol = r;
                  mi_CurrentBlockRow = (int) ((Gdx.input.getY() - (mScreenHeight/6)) / mBlockHeight);
      ...
      private void addMoreBricks() {
            if ( System.currentTimeMillis() - mTimeOfLastBrickDrop > mTimeBetweenBrickDrops) {
                  ...
                  if ( check != null ) {
                        ...
                        y = mScreenHeight-mBlockHeight;
                        mBricks[0][columnToDropIn] = new Brick(x,y, mBlockHeight, mBlockHeight/48);
